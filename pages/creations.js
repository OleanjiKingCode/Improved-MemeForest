  ...
  const FechMemeInfo = async (props) => {
    ...
    const tx = await Promise.all(
      data.map(async (i) => {
        ...
        const StarAnswer = await contractWithProvider.WhatDidIStar(
          i.id,
          person
        );
        const LikeAnswer = await contractWithProvider.WhatDidILike(
          i.id,
          person
        );
        ...
        <div className="flex flex-row items-center justify-center">
          {loadingpage ? (
            ...
            <>
              ...
              <h4>There are no Memes For Display</h4>
            </>
          )}
        </div>
      );
                            ...
                            <div className="flex flex-col">
                              ...
                              <div className="py-2 px-3 border-2 border-gray-500 h-auto mx-2 mt-4 rounded-lg">
                                ...
                                <div className="flex flex-row  justify-between space-x-1">
                                  <button
                                    className="rounded-md border-2 border-black flex mt-3  items-center justify-around h-8 w-24 hover:bg-[#FFFF00] "
                                    onClick={() =>
                                  ...
                                  <button
                                    className="rounded-md border-2 border-black flex mt-3  items-center justify-around h-8 w-24 hover:bg-[#ff0000] "
                                    onClick={() =>
